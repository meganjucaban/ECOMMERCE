...
include(ROOT_DIR."app/config/DatabaseConnect.php");
    ...
    $product = [];
    $id = @$_GET['id'];
    $category = ["1" => "Electronics", "2" => "Fashion", "3" => "Home Appliances", "4" => "Appliances"];
        ...
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
         ...
         <?php } ?>
            ...
            <div class="row">
                <!-- Product Image -->
                <div class="col-md-6">
                    <img src="<?php echo BASE_URL.$product["image_url"]; ?>" alt="Product Image" class="img-fluid border border-info border-5" style="height:500px">
                </div>
